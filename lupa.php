...
<html>
	...
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.min.js" integrity="sha384-kjU+l4N0Yf4ZOJErLsIcvOU2qSb74wXpOhqTvwVx3OElZRweTnQ6d31fXEoRD1Jy" crossorigin="anonymous"></script>
		...
		<body style="background:linear-gradient(to right, #009dff, #00ffdd);">
			...
			if(isset($_GET['pesan'])){
				if($_GET['pesan']=="gagal"){
					echo "<div class='alert alert-danger p-3 mx-auto mb-1'>Username Tidak ditemukan!!</div>";
				}
			}
			?>
			<table>
			...
			<form action="cek_pass.php" method="post">
				<div class="mb-3">
				<h3 align="center">Lupa Password</h3>
				</div>
			<div class="mb-2 mt-2">
			...
			<button type="submit" class="btn btn-primary" value="ubah">Ubah Password</button>
			</div>
			</form>
			<div align=center class="my-5">
