...
session_start();
  ...
  if($_SESSION['level']=="adm"){
    echo "<script>alert('Anda Tidak Memiliki Akses');window.location='detailbarangkeluaradm.php';</script>;";
  }
	if($_SESSION['level']=="stf"){
   echo "<script>alert('Anda Tidak Memiliki Akses');window.location='detailbarangkeluar.php';</script>;";
  }
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="detailbarangmasukmgr.php" class="nav-link">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="detailbarangkeluarmgr.php" class="nav-link">
                <i class="fas fa-info nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="detailbarangreturmgr.php" class="nav-link">
                <i class="fas fa-info nav-icon"></i>
              <p>
                Detail Barang Retur
              </p>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		<h1 align="center">DETAIL BARANG KELUAR</h1>
			...
			<td align="right" width="25%"><div class="mb-1">
				<form class="d-flex" action="detailbarangkeluarmgr.php" method="post">
