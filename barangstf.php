...
include 'koneksi.php';
  ...
  if(isset($_POST['tambah'])){
    ...
    if (!$tambah) {
      echo "<script>alert('Pastikan semua kolom terisi dengan benar! ');window.location='barangstf.php';</script>;";
    }else{
      echo "<script>alert('Data Berhasil Ditambahkan');window.location='barangstf.php';</script>;";
    }
}
if(isset($_POST['updatebarang'])){
    ...
    $updatebarang = mysqli_query($koneksi,"update barang set nama_barang='$nama_barang', keterangan='$keterangan' where id_barang='$id_barang'");
     if (!$updatebarang) {
      ...
      echo "<script>alert('Data Berhasil Diubah');window.location='barangstf.php';</script>;";
    }
   }
  ...
  <div class="content-wrapper">
    ...
    <h1 align="center">DAFTAR BARANG</h1>
      ...
      <td align="right" width="25%"><div class="mb-1">
        <form class="d-flex" action="barangstf.php" method="post">
