...
include 'koneksi.php';
  ...
  if($_SESSION['level']=="adm"){
    echo "<script>alert('Anda Tidak Memiliki Akses');window.location='barangreturadm.php';</script>;";
  }
	if($_SESSION['level']=="mgr"){
   echo "<script>alert('Anda Tidak Memiliki Akses');window.location='barangreturmgr.php';</script>;";
  }
  ...
  if(isset($_POST['brgretur'])) {
    ...
    $updetail = mysqli_query($koneksi,"update detailbarangretur set id_barangretur = id_detailbarangretur");
      ...
      if (!$brgretur) {
      echo "<script>alert('Pastikan semua kolom terisi dengan benar! ');window.location='barangreturstf.php';</script>;";
    }else{
      echo "<script>alert('Data Berhasil Ditambahkan');window.location='barangreturstf.php';</script>;";
    }
    }
    ...
    echo "<script>alert('Data Berhasil Diubah');window.location='barangreturstf.php';</script>;";
    }
      }else {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <td align="right" width="25%"><div class="mb-1">
        <form class="d-flex" action="barangreturstf.php" method="post">
   ...
   <table id="example2" class="table table-bordered table-hover dataTable dtr-inline w-75 mx-auto" aria-describedby="example2_info">
          ...
          <tbody>
            ...
            <tr align="center">
                ...
                <td><?=$keterangan;?></td>
              <td>
                <button class="fas fa-info nav-iconbtn btn-primary" data-bs-toggle="modal" data-bs-target="#detail<?=$id_barangkeluar;?>"></button>&emsp;
                <button class="btn btn-danger"data-bs-toggle="modal" data-bs-target="#delete<?=$id_retur;?>"><img src="hapus.png" width="20px" height="20px"></button>
                <button class=" btn btn-secondary" data-bs-toggle="modal" data-bs-target="#edit<?=$id_retur;?>"><img src="edit.png" width="20px" height="20px"></button>&emsp;
               
                <div class="modal fade" id="detail<?=$id_barangkeluar;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="brgmasuk">Detail Barang Keluar</h5>
      </div>
      <div class="modal-body">
