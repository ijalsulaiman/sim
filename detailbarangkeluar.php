...
<div class="wrapper">
 ...
 session_start();
  ...
  if($_SESSION['level']=="adm"){
   ...
   echo "<script>alert('Anda Tidak Memiliki Akses');window.location='detailbarangkeluarmgr.php';</script>;";
  }
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="detailbarangmasuk.php" class="nav-link">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="detailbarangkeluar.php" class="nav-link">
                <i class="fas fa-info nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="detailbarangretur.php" class="nav-link">
                <i class="fas fa-info nav-icon"></i>
              <p>
                Detail Barang Retur
              </p>
      ...
      <div class="container-fluid">
		<h1 align="center">DETAIL BARANG KELUAR</h1>
			...
			<td align="right" width="25%"><div class="mb-1">
				<form class="d-flex" action="detailbarangkeluarstf.php" method="post">
