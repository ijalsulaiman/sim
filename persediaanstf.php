...
include 'koneksi.php';
  ...
  if(isset($_POST['tambahpersediaan'])){
    ...
    $tambahpersediaan = mysqli_query($koneksi,"insert into persediaan_barang (id_persediaan, id_barang, stok, satuan, id_gudang, safety_stock) values('','$id_barang','$stok','$satuan','$id_gudang','1')");
    $tambahrop = mysqli_query($koneksi,"insert into perencanaan (id_perencanaan, id_barang, rop) values('','$id_barang','1')");
      if (!$tambahpersediaan) {
      echo "<script>alert('Pastikan semua kolom terisi dengan benar! ');window.location='persediaanstf.php';</script>;";
    }else{
      echo "<script>alert('Data Berhasil Ditambahkan');window.location='persediaanstf.php';</script>;";
    }
}
if(isset($_POST['updatepersediaan'])){
    ...
    if (!$updatepersediaan) {
      ...
      echo "<script>alert('Data Berhasil Diubah');window.location='persediaanstf.php';</script>;";
    }
   }
...
<div class="content-wrapper">
    ...
    <h1 align="center">PERSEDIAAN BARANG</h1>
      ...
      <td align="right" width="25%"><div class="mb-1">
        <form class="d-flex" action="persediaanstf.php" method="post">
