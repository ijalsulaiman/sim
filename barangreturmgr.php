...
include 'koneksi.php';
  ...
  if($_SESSION['level']=="adm"){
   ...
   echo "<script>alert('Anda Tidak Memiliki Akses');window.location='barangreturstf.php';</script>;";
  }
      ...
      <div class="container-fluid">
		...
		<h1 align="center">BARANG RETUR</h1>
			...
			<td align="right" width="25%"><div class="mb-1">
				<form class="d-flex" action="barangreturmgr.php" method="post">
