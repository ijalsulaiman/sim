    ...
    <section class="content">
      <div class="container-fluid">
		<h1 align="center">BARANG KELUAR</h1>
			...
			<td align="right" width="25%"><div class="mb-1">
				<form class="d-flex" action="barangkeluarmgr.php" method="post">
	 ...
	 <table id="example2" class="table table-bordered table-hover dataTable dtr-inline w-75 mx-auto" aria-describedby="example2_info">
          ...
          <tbody>
            ...
            if (isset($_POST['cari'])) {
              $cari = $_POST['cari'];
              $ambildata = mysqli_query($koneksi,"select barang_keluar.id_barangkeluar,barang_keluar.id_barang, barang.nama_barang, barang_keluar.tanggalkeluar, barang_keluar.jumlah, barang_keluar.satuan, barang_keluar.keterangan, detailbarangkeluar.spesifikasi, detailbarangkeluar.customer from barang_keluar join barang on barang.id_barang=barang_keluar.id_barang join detailbarangkeluar on detailbarangkeluar.id_barangkeluar=barang_keluar.id_barangkeluar where barang.nama_barang like '%".$cari."%' or barang_keluar.tanggalkeluar like '%".$cari."%' or barang_keluar.jumlah like '%".$cari."%'");
            } else{
            ...
            <tr align="center">
                ...
                <td><?=$satuan;?></td>
                <td><?=$keterangan;?></td>
							<td><button class="fas fa-info nav-iconbtn btn-primary" data-bs-toggle="modal" data-bs-target="#detail<?=$id_barangkeluar;?>"></button>&emsp;
