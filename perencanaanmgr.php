...
include 'koneksi.php';
  ...
  if($_SESSION['level']=="adm"){
    echo "<script>alert('Anda Tidak Memiliki Akses');window.location='perencanaanadm.php';</script>;";
  }
   ...
   <table id="example2" class="table table-bordered table-hover dataTable dtr-inline w-75 mx-auto" aria-describedby="example2_info">
          ...
          <tbody>
            <?php
              if (isset($_POST['cari'])) {
              $cari = $_POST['cari'];
            $ambildata = mysqli_query($koneksi,"select perencanaan.id_perencanaan, perencanaan.id_barang, barang.nama_barang, persediaan_barang.stok,persediaan_barang.safety_stock, avg(detailbarangmasuk.lead), avg(barang_keluar.jumlah) from perencanaan inner join barang on barang.id_barang=perencanaan.id_barang inner join persediaan_barang on persediaan_barang.id_barang=perencanaan.id_barang inner join detailbarangmasuk on detailbarangmasuk.id_barang=perencanaan.id_barang inner join barang_keluar on barang_keluar.id_barang=perencanaan.id_barang where perencanaan.id_barang like '%".$cari."%' or barang.nama_barang like '%".$cari."%' or persediaan_barang.stok like '%".$cari."%' and persediaan_barang.safety_stock > persediaan_barang.stok group by perencanaan.id_barang");
            } else{
            $ambildata = mysqli_query($koneksi,"select perencanaan.id_perencanaan, perencanaan.id_barang, barang.nama_barang, persediaan_barang.stok,persediaan_barang.safety_stock, avg(detailbarangmasuk.lead), avg(barang_keluar.jumlah) from perencanaan inner join barang on barang.id_barang=perencanaan.id_barang inner join persediaan_barang on persediaan_barang.id_barang=perencanaan.id_barang inner join detailbarangmasuk on detailbarangmasuk.id_barang=perencanaan.id_barang inner join barang_keluar on barang_keluar.id_barang=perencanaan.id_barang where persediaan_barang.safety_stock > persediaan_barang.stok group by perencanaan.id_barang");
            }
            ...
            <tr align="center">
                ...
                <td><?=floor((2*($ratapermintaann*$ratalead)+$safety_stock)-(($ratapermintaann*$ratalead)+$safety_stock));?></td>
            </tr>
<?php
						};
						?>
