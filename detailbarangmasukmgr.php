...
session_start();
  ...
  if($_SESSION['level']=="adm"){
    echo "<script>alert('Anda Tidak Memiliki Akses');window.location='detailbarangmasukadm.php';</script>;";
  }
	if($_SESSION['level']=="stf"){
   echo "<script>alert('Anda Tidak Memiliki Akses');window.location='detailbarangmasuk.php';</script>;";
  }
  ...
  <div class="content-wrapper">
    ...
    <h1 align="center">DETAIL BARANG MASUK</h1>
      ...
      <td align="right" width="25%"><div class="mb-1">
        <form class="d-flex" action="detailbarangmasuk.php" method="post">
